let sketch = function(p) {
    let number_of_trees = 42;
    let columns = 9;
    let trees = [];
    let radius = 400;
    let initial_boundary_size = 9;
    let number_of_tries = 17;
    ...
    p.setup = function() {
      ...
      p.stroke(0);
      p.strokeWeight(1);
      colors = [p.color('#CC5177'), p.color('#AD6068'), p.color('#2D313B'), p.color('#F3C855'), p.color('#9EA683')];
