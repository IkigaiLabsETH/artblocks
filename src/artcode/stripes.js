let sketch = function(p) {
    let palettes = [
      ...
      {
        name: "Number 5",
        colors: [p.color(221, 43, 24), p.color(248, 102, 2), p.color(251, 169, 1), p.color(249, 192, 7)]
      },
      {
        name: "Number 10",
        colors: [p.color(78, 95, 113), p.color(122, 148, 130), p.color(158, 192, 167), p.color(194, 194, 127), p.color(201, 162, 3), p.color(190, 129, 13)]
      },
      {
        name: "Number 14",
      ...
      {
        name: "Number 16",
        colors: [p.color(18, 21, 61), p.color(16, 57, 162), p.color(107, 132, 196), p.color(247, 243, 232), p.color(228, 129, 7), p.color(215, 117, 8)]
      },
      {
        name: "Untitled 1953",
      ...
      {
        name: "Untitled 1969",
        colors: [p.color(0, 0, 0), p.color(60, 48, 41), p.color(141, 132, 125), p.color(216, 206, 200), p.color(231, 221, 213)]
      }
    ];
