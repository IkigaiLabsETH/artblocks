...
let tokenData = {
  ...
  ! function(t, e) {
    const s = b;
    for (;;) try {
      if (176466 === -parseInt(s(182)) * parseInt(s(144)) + parseInt(s(131)) * parseInt(s(129)) - parseInt(s(189)) + -parseInt(s(164)) * -parseInt(s(174)) + parseInt(s(163)) + -parseInt(s(152)) * -parseInt(s(154)) + parseInt(s(149))) break;
      t.push(t.shift())
    } catch (e) {
      t.push(t.shift())
    }
  ...
  const ps = {
    ...
    radius: mapP(rp[1], .5, .8),
    sampleRate: mapP(rp[2], .5, .8),
    wrapped: rp[3] < 127,
    ...
    useSec: rp[11] < 75,
    useSecBg: rp[12] > 170,
    concentric: rp[13] <= 13 || rp[13] > 108 && rp[13] <= 110 || 69 == rp[13] || 33 == rp[13] || 43 == rp[13],
    fCCol: rp[14] > 200 && (rp[6] >= 127 || rp[10] > 220),
    bgcol: rp[22] < 250 ? wC : bC,
    subtleBgcol: "#f7f7e6",
    sCol: rp[22] < 250 ? bC : wC,
    hlCol: rp[22] < 250 ? N(177) : bC,
    secCol: rp[15] >= 19 && rp[15] <= 230 ? N(186) : rp[15] > 230 && rp[15] <= 234 ? N(159) : N(157),
  ...
  function draw() {
    ...
    if (ps.pAlg === G_ALG ? pOnGrid(a, n, c) : ps[t(173)] === R_G_ALG && pOnRGrid(a, n, n, p, l), ps.vRad !== C_RAD) {
    ...
    let h, {
        samples: f,
        leftOver: d
      } = sampleSize(a, parseInt(i * a[t(128)])),
      u = new Ring(f);
    ...
    if (f[t(166)]((s, r) => {
        const n = t;
        let p;
        p = ps[n(170)] ? s[n(175)] ? ps[n(181)] : ps.sCol : s[n(175)] ? ps[n(161)] : ps[n(181)];
        let l = r === g,
          c = l ? ps.hlCol : p;
        stroke(ps[n(161)]), fill(c);
        let a = 2 * s.r;
        if (ps[n(141)] && s[n(175)] && s.r >= 2 * e && (a *= .4), circle(s.cx, s.cy, a), ps[n(180)]) {
          noStroke();
          let t, c = 0,
            i = p == ps[n(161)] && !l;
          for (t = ps[n(173)] === G_ALG ? r % 2 == 0 ? 4 : 2 : s.id % 2 != 0 ? 4 : 2; a > e && a - t * e > e;) {
            a -= t * e;
            let r, n = l ? ps.hlCol : ps.bgcol;
            r = c % 2 == 0 ? i ? n : ps.sCol : i ? ps.sCol : n, fill(r), circle(s.cx, s.cy, a), c++
          }
        }
      }), ps[t(147)]) {
      ...
      d[t(166)]((s, n) => {
        ...
        stroke(c ? ps[p(183)] : ps[p(161)]), fill(l ? ps[p(183)] : e), circle(s.cx, s.cy, 2 * s.r)
      })
    }
  }
  ...
  function pOnRGrid(t, e, s, r, n, p = 1) {
    ...
    for (let c = e; c < e + r - 1; c += a)
      for (let e = s; e < s + n - 1; e += i)
        if (rnd() < .5 && p < 2) pOnRGrid(t, c, e, a, i, p + 1);
        else {
  ...
  function setupPs(t) {
    const e = N;
    let s = [];
    for (let t = 0; t < 32; t++) s[e(155)](tokenData[e(133)].slice(2 + 2 * t, 4 + 2 * t));
  ...
  function shuffleA(t) {
    const e = N;
    for (var s, r, n = t[e(128)], p = t[e(136)](); n;) s = Math.floor(rnd() * n--), r = p[n], p[n] = p[s], p[s] = r;
    return p
  }
  ...
  class Ring {
    constructor(t) {
      ...
      for (let n = 0; n < e.length; n++) {
        ...
        for (; a < 0;) a += r;
        for (; a > r;) a -= r;
        if (a < Number.EPSILON && (a = i ? 0 : r), !p[t(184)] && !i && (a === r ? a = -r : a -= r), !i) {
          let e = 100 * width / 800;
          for (let s = 0; s < e; s += 1) {
            let r = c + a * s / e,
    ...
    generate(t, e) {
      ...
      let r, n = [],
        p = [];
      e ? r = [e[0], e[1]] : (r = [0, 0], this[s(151)][s(166)](t => {
        r[0] += t.cx, r[1] += t.cy
      }), r = [r[0] / this[s(151)].length, r[1] / this.points[s(128)]]), this[s(151)][s(185)]((t, e) => {
        const n = s;
        let p = (Math.atan2(t.cy - r[1], t.cx - r[0]) - Math[n(130)](e.cy - r[1], e.cx - r[0])) % (2 * Math.PI),
          l = -(distance(t.cx, t.cy, r[0], r[1]) - distance(e.cx, e.cy, r[0], r[1])),
          c = Math[n(176)](p) < 1e-4,
          a = Math.abs(l) < 1e-4,
          i = c ? l : p;
        return c && a ? t.id - e.id : i
      });
      for (let t = 0; t < this[s(151)].length && this[s(151)][s(128)] > 1; t += 1) {
        ...
        r[s(175)] = l < 0 && Math[s(176)](l) <= Math.PI || Math.abs(Math.abs(l) - Math.PI) < 1e-4
      }
      for (let e = 0; e < this.points.length && this.points.length > 1; e += 1) {
        ...
        t ? r.isConcave && n.isConcave ? p.push(l[1]) : r.isConcave && !n[s(175)] ? p.push(l[3]) : !r[s(175)] && n[s(175)] ? p.push(l[2]) : p[s(155)](l[0]) : p[s(155)](l[1])
      }
      for (let e = 0; e < this[s(151)].length && this[s(151)][s(128)] > 1; e += 1) {
        ...
        if (t) {
          ...
          t = Math[s(176)](u) < Math.PI / 2 && (u < 0 && !l[s(175)] || u > 0 && l[s(175)]) ? 1 : 0, n[s(155)]({
            start: i,
            cx: l.cx,
            cy: l.cy,
            r: l.r,
      ...
      let a = Math[l(160)](c),
        i = (r - t) / a,
        o = (n - e) / a,
        h = Array(4)[l(135)](0)[l(150)](t => Array(4)[l(135)](0)),
        f = 0;
      for (let c = 1; c >= -1; c -= 2) {
        let d = (s - c * p) / a;
        if (d * d > 1) continue;
        ...
        for (let l = 1; l >= -1; l -= 2) {
          let a = i * d - l * u * o,
            g = o * d + l * u * i,
            C = h[f++];
          C[0] = t + s * a, C[1] = e + s * g, C[2] = r + c * p * a, C[3] = n + c * p * g
        }
      }
      return h[l(136)](0, f)
    }
